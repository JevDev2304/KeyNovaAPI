...
@accessRouter.delete("/", status_code=status.HTTP_200_OK, response_model=Access)
async def access(access: Access):
    dbConnection.eliminar_acceso(access.Propiedad_idPropiedad, access.Agente_idAgente)
